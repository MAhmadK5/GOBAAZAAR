...
export default function OrdersModule() {
  ...
  return (
    <div className="w-full max-w-full overflow-hidden pb-20">
      ...
      {/* ✨ UNIVERSAL TABS (Fixed for all screens, scrollable horizontally if needed) ✨ */}
      ...
      {statusModal && (
        <div className="fixed inset-0 z-[99999] flex items-center justify-center p-4 animate-fade-in">
          ...
          <div className="relative bg-zinc-950 border border-white/10 rounded-[2rem] sm:rounded-[2.5rem] w-full max-w-md p-6 sm:p-10 shadow-2xl text-center">
            ...
            <p className="text-xs sm:text-sm text-zinc-400 font-light mb-8">
              ...
              <br/><br/>
              <span className="text-amber-500 font-bold bg-amber-500/10 px-2 sm:px-3 py-1 rounded-lg inline-block mt-1">This will instantly trigger an automated email to the customer.</span>
            </p>
